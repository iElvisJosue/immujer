...
import useEnviarNotificacionPersonalizada from "../../../hooks/llamadas/Lista/useEnviarNotificacionPersonalizada";
...
import "../../../styles/components/llamadas/Lista/ModalEnviarNotificacionPersonalizada.css";
...
export default function ModalEnviarNotificacionPersonalizada({
  ...
  return (
    <div className="ModalEnviarNotificacionPersonalizada">
      <form
        className="ModalEnviarNotificacionPersonalizada__Contenido"
      ...
      >
        {enviandoNotificacion ? (
          ...
          <>
            <button
              type="button"
              className="ModalEnviarNotificacionPersonalizada__Contenido--CerrarModal"
              onClick={() => onCerrarModal()}
            >
              <ion-icon name="close"></ion-icon>
            </button>
            <span className="ModalEnviarNotificacionPersonalizada__Contenido--ImagenTitulo">
              <img
            ...
            <button className="ModalEnviarNotificacionPersonalizada__Contenido--Boton">
              Enviar notificación
            </button>
            <small className="ModalEnviarNotificacionPersonalizada__Contenido--TextoInformativo">
              ¡La notificación se enviará únicamente a esta persona!
            </small>
          </>
        )}
      </form>
