...
// HOOKS A USAR
import useRegistrarBoletin from "../../../hooks/boletines/Registrar/useRegistrarBoletin";
...
// ESTILOS A USAR
import "../../../styles/components/boletines/Registrar/RegistrarBoletin.css";

export default function RegistrarBoletin({ PropsUsuario: { idUsuario } }) {
  const {
    getRootProps,
    getInputProps,
    isDragActive,
