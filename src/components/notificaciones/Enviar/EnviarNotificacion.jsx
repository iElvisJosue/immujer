...
import useEnviarNotificacion from "../../../hooks/notificaciones/Enviar/useEnviarNotificacion";
// COMPONENTES A USAR
...
// ESTILOS A USAR
import "../../../styles/components/notificaciones/Enviar/EnviarNotificacion.css";

export default function EnviarNotificacion({ PropsUsuario: { idUsuario } }) {
  const {
    isDragActive,
    getRootProps,
    getInputProps,
  ...
  const { register, CampoRequerido, PeticionEnviarNotificacion } =
  ...
  return (
    <form onSubmit={PeticionEnviarNotificacion} className="EnviarNotificacion">
      ...
      <FooterBotones VerBotonNegativo={false} TextoBotonPositivo="Enviar" />
    </form>
  );
}
