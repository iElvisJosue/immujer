...
import useRegistrarDependencia from "../../../hooks/dependencias/Registrar/useRegistrarDependencia";
// COMPONENTES A USAR
...
// ESTILOS A USAR
import "../../../styles/components/dependencias/Registrar/RegistrarDependencia.css";

export default function RegistrarDependencia({ PropsUsuario: { idUsuario } }) {
  const {
    getRootProps,
    getInputProps,
    isDragActive,
