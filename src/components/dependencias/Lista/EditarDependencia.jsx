...
// HOOKS A USAR
import useEditarDependencia from "../../../hooks/dependencias/Lista/useEditarDependencia";
...
// ESTILOS A USAR
import "../../../styles/components/dependencias/Lista/EditarDependencia.css";

export default function EditarDependencia({
  PropsVista: { establecerSubvistaActual },
  PropsContenido: { infDependenciaSeleccionada },
}) {
  const {
    getRootProps,
    getInputProps,
