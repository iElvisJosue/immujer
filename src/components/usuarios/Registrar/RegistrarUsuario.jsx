// HOOKS A USAR
import useRegistrarUsuario from "../../../hooks/usuarios/Registrar/useRegistrarUsuario";
// COMPONENTES A USAR
...
export default function RegistrarUsuario() {
  ...
  return (
    <form onSubmit={PeticionRegistrarUsuario} className="RegistrarUsuario">
      ...
      <FooterBotones VerBotonNegativo={false} TextoBotonPositivo="Registrar" />
    </form>
  );
}
